...
export const metadata: Metadata = {
  ...
  description: "Directions and location for the Hilliard Family Fun Run at Hilliard Sports Complex.",
};

const tips = [
  {
    title: "Ample Parking",
    body: "There is plenty of parking within the Hilliard Sports Complex area. Please exercise caution when you arrive.",
    icon: <ParkingCircle className="h-5 w-5" strokeWidth={2.2} />,
  },
  {
    title: "Arrive Early",
    body: "Give yourself time to park, warm up, and find your start area before the 9:00 AM 5K start.",
    icon: <Clock3 className="h-5 w-5" strokeWidth={2.2} />,
  },
  {
    title: "Follow Signage",
    body: "Follow event signage and volunteers on site for safe arrival and smooth race flow.",
  ...
  return (
    <PageShell
      ...
      hero={{
        ...
        subtitle:
          "All activities staged at Hilliard Sports Complex, directly across from the new Wellness Fitness Center.",
        imageUrl: "/eventd.jpg",
      }}
    >
          ...
          <div className="lg:col-span-5">
            <div className="rounded-[24px] border border-white/15 bg-[#1e252d] p-6 shadow-[0_18px_44px_rgba(0,0,0,0.35)] sm:p-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold uppercase tracking-[0.18em] text-white/85">Address</p>
            ...
            <div className="overflow-hidden rounded-[24px] border border-white/15 bg-white/5 shadow-[0_18px_44px_rgba(0,0,0,0.30)]">
              <div className="flex flex-col gap-2 border-b border-white/10 px-6 py-5 sm:px-8">
                ...
                <p className="text-base leading-7 text-white/80 sm:text-lg sm:leading-8">
                  Tap and zoom to plan your route to the Hilliard Sports Complex.
                </p>
              </div>

              <div className="h-[340px] w-full sm:h-[420px] lg:h-[520px]">
                <iframe
                  title="Hilliard Sports Complex map"
