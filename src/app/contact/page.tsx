...
export const metadata: Metadata = {
  title: "Contact | Columbus Turkey Trot",
  description: "Contact Columbus Turkey Trot for race registration questions and race day information.",
};
...
const visitReasons = [
  "Race morning details are shared before Thanksgiving week",
  "Tot Trot starts at 8:30 am and main event starts at 9:00 am",
  "Location: Shops on Lane Avenue, Columbus",
];
