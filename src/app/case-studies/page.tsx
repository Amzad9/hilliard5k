...
const faq = [
  ...
  },
  {
    ...
    body: "Use available public parking around Shops on Lane Avenue and nearby areas as directed on race morning.",
  ...
  return (
    <PageShell
      ...
      hero={{
        ...
        imageUrl: "https://images.unsplash.com/photo-1483721310020-03333e577078?auto=format&fit=crop&w=1400&q=80",
      }}
    >
        ...
        <div className="container mx-auto grid gap-6 lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            <ul className="mt-6 space-y-3 text-base leading-7 text-white/90 sm:text-lg sm:leading-8">
              ...
              <li className="rounded-2xl border border-white/15 bg-white/5 px-5 py-4">
                <span className="font-black text-white">Start times:</span> Tot Trot at 8:30 am and main event at 9:00 am on Thanksgiving Day.
              </li>
              <li className="rounded-2xl border border-white/15 bg-white/5 px-5 py-4">
                <span className="font-black text-white">Location:</span> Shops on Lane Avenue, Columbus.
              </li>
              <li className="rounded-2xl border border-white/15 bg-white/5 px-5 py-4">
                <span className="font-black text-white">Parking:</span> Use marked public parking in nearby areas.
              </li>
            </ul>
